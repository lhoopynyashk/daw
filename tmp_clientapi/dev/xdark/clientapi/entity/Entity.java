...
public interface Entity {
  ...
  DataParameter<Byte> FLAGS = instanceStub();
  DataParameter<Integer> AIR = instanceStub();
  DataParameter<String> CUSTOM_NAME = instanceStub();
  DataParameter<Boolean> CUSTOM_NAME_VISIBLE = instanceStub();
  DataParameter<Boolean> SILENT = instanceStub();
  DataParameter<Boolean> NO_GRAVITY = instanceStub();
  ...
  void updateCustomNbt(Consumer<NBTTagCompound> handler);
